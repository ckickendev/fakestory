...
public class APIReact extends HttpServlet {
	...
	new ReactDAO().addReact(Integer.valueOf(request.getParameter("userid")) , Integer.valueOf(request.getParameter("postid")), Integer.valueOf(request.getParameter("type")));
