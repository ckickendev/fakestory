...
//	ResultSet rs = null;
	...
	if (con != null) {
		...
		rs = ps.executeQuery();
		if(rs.next()) {
		    user = new User(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getInt(6), rs.getString(7), rs.getInt(8), rs.getString(9), rs.getTimestamp(10)  );
		}
	    } catch (SQLException e) {
		e.printStackTrace();
	    }
	...
	if (con != null) {
		...
		rs = ps.executeQuery();
		while(rs.next()) {
		    users.add(new User(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getInt(6), rs.getString(7), rs.getInt(8), rs.getString(9), rs.getTimestamp(10)));
		}
	    } catch (SQLException e) {
		e.printStackTrace();
	    }
